    ...
    */
            ...
            if (chainConstruct) {
                constructor = (function(originalConstructor) {
                    return function() {
                        ...
                        this.$$super = constructorClosure.constructor.$super.constructor.prototype;
                        this.$$orig = constructorClosure.constructor.$orig;
                        this._super2 || (this._super2=1);
                        this._super2 = this._super2+1;
    ...
    Object.defineProperties(BASE_MEMBERS, {
        ...
        $$$$super: {
            get: function() {
                // return this._super2;
                return this._superClass.m ? this._superClass.m : 'NO m';
                // return this._superClass.prototype;
            }
        },
        $$$$orig: {
            get: function() {
                return {m: 'i am the getter of $orig.m'};
            }
        }
    });
console.warn(Object.keys(BASE_MEMBERS));
