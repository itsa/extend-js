...
var createHashMap = require('js-ext/extra/hashmap.js').createMap,
    ...
    cloneObj = function(obj, descriptors) {
        ...
        if (obj instanceof Array) {
            ...
            for (i=0; i<len; i++) {
                value = obj[i];
                copy[i] = Object.isObject(value) ? cloneObj(value, descriptors) : value;
            }
            return copy;
        }
...
defineProperties(Object.prototype, {
    ...
    shallowClone: function (descriptors) {
        ...
        while (++i < l) {
            key = keys[i];
            if (descriptors) {
                Object.defineProperty(m, key, Object.getOwnPropertyDescriptor(instance, key));
            }
            else {
                m[key] = instance[key];
            }
     ...
     */
    deepClone: function (descriptors) {
        var instance = this,
            m = {},
            keys = Object.getOwnPropertyNames(instance),
            l = keys.length,
        ...
        while (++i < l) {
            ...
            if (descriptors) {
                ...
                if (Object.isObject(value) && (typeof propDescriptor.get)!=='function') {
                    m[key] = cloneObj(value, true);
                }
            }
            else {
                m[key] = Object.isObject(value) ? cloneObj(value) : value;
            }
        }
        return m;
    },
    ...
    merge: function (obj, options) {
        ...
        while (++i < l) {
            ...
            if (force || !(key in instance)) {
                if (descriptors) {
                    Object.defineProperty(instance, key, Object.getOwnPropertyDescriptor(obj, key));
                }
                else {
